...
const en = {
  ...
  supportedFileTypes:
    "Supported file types: Only PDF, text files, and images (PNG, JPEG, GIF, WebP) are supported. Maximum file size: 2MB. Larger files may cause processing errors, consider splitting into smaller chunks if needed.",
